...
from mysingle_protos.protos.services.genai.v1 import strategy_builder_pb2 as protos_dot_services_dot_genai_dot_v1_dot_strategy__builder__pb2
...
def add_StrategyBuilderServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('genai.strategy_builder.StrategyBuilderService', rpc_method_handlers)
